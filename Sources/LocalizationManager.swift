...
private let TurkishStrings: [String: String] = [
    ...
    "preset.discord_aggressive": "Discord Agresif",
    "preset.stealth": "Gizli",
    "preset.paranoid": "Paranoyak",
    "preset.oob": "OOB",
    "preset.fake_ttl": "Fake TTL",
    "preset.light": "Hafif",
    "preset.custom": "Özel",
    "preset.standard.desc": "Günlük kullanım için optimize",
    "preset.gaming.desc": "Düşük gecikme, oyun için",
    "preset.streaming.desc": "Video akışı için optimize",
    "preset.privacy.desc": "Maksimum gizlilik",
    "preset.discord.desc": "Discord için ayarlar",
    "preset.discord_aggressive.desc": "Ağır engelleme için",
    "preset.stealth.desc": "TLS ile gizli geçiş",
    "preset.paranoid.desc": "Tüm teknikler birleşik",
    "preset.oob.desc": "Out-of-Band veri",
    "preset.fake_ttl.desc": "Sahte TTL paketleri",
    "preset.light.desc": "Minimum müdahale",
    "preset.custom.desc": "Özel parametreler",
    "dashboard.modes": "mod",
...
private let EnglishStrings: [String: String] = [
    ...
    "preset.discord": "Discord",
    "preset.discord_aggressive": "Discord Aggressive",
    ...
    "preset.standard.desc": "Optimized for daily use",
    "preset.gaming.desc": "Low latency for gaming",
    "preset.streaming.desc": "Optimized for video streaming",
    "preset.privacy.desc": "Maximum privacy",
    "preset.discord.desc": "Discord specific settings",
    "preset.discord_aggressive.desc": "For heavy blocking",
    "preset.stealth.desc": "TLS stealth bypass",
    "preset.paranoid.desc": "All techniques combined",
    "preset.oob.desc": "Out-of-Band data",
    "preset.fake_ttl.desc": "Fake TTL packets",
    "preset.light.desc": "Minimal intervention",
    "preset.custom.desc": "Custom parameters",
